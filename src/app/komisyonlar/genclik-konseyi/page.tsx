...
export const metadata = {
  title: "Gençlik Konseyi",
  description: "Gençlik Konseyi çalışmaları ve gönüllülük bilgileri.",
};
  ...
  return (
    <main className="py-16">
      <div className="mx-auto max-w-5xl space-y-10 px-4">
        <SectionTitle
          eyebrow="Gençlik Konseyi"
          title="Gençliğin Enerjisi, Hitit’in Mirası"
          description="Dinamik, modern ve üretken bir gençlik için kültürel bellek ve dayanışma projeleri."
        />
        ...
        <div className="rounded-3xl border border-[#e5dfd8] bg-white p-8 shadow-sm">
          ...
          <h2 className="mt-3 text-3xl font-semibold text-[#1f2a44]">Cem Hökelek</h2>
          <p className="mt-4 text-sm text-[#5f677a]">
            Gençlik Konseyi; kültürel mirası dijital çağla buluşturan, güçlü sivil toplum
            ağlarıyla gençliği destekleyen projeler geliştirir.
          </p>
